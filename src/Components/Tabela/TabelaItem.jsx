    ...
    return (
        ...
        <div className="container mx-auto mt-10">
            <div className="flex flex-row-reverse mb-4">
                <button className="flex justify-center items-center rounded-lg bg-blue-600 px-2 py-2 shadow-sm text-white text-sm uppercase font-medium
                    ...
                    <tbody>
                        {itens.map((item) => (
                            <tr key={item.id} className="bg-white border-b bg-gray-800 border-gray-300 text-center">
                                ...
                                <td className="px-6 py-4">
                                    {new Date(item.publicacao).toLocaleDateString('pt-BR', { timeZone: 'UTC' })}
                                </td>
                                <td className="px-6 py-4">
                                    <div className="flex justify-center">
                                        <button type='button' className="flex justify-center items-center w-12 rounded-l-lg border-r border-blue-700 bg-blue-600 py-1 shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">

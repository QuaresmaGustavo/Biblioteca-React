                            ...
                            <tr key={item.id} className="bg-white border-b bg-gray-800 border-gray-300 text-center">
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex justify-center">
                                        ...
                                        <button type='button' className="flex justify-center items-center w-12 rounded-r-lg bg-indigo-600 py-1 shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                            <a href={"/modal_item?id="+item.id}>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 text-white">
